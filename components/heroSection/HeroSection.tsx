        ...
        <div className="flex flex-col  gap-6 md:flex-row items-center max-w-8xl">
          <div className="w-full md:w-1/2 lg:pr-32">
            ...
            <h3 className="mt-6 md:mt-10 text-md lg:text-xl text-center md:text-left text-gray-700 font-light tracking-wider leading-relaxed">
              متخصصين في تقديم مواد غذائية عالية الجودة، تتميز
              منتجاتنا بالنكهة الفريدة والقيمة الغذائية العالية. تسعى الشركة
              لتلبية احتياجات العملاء عبر توفير تشكيلة متنوعة من المنتجات التي
